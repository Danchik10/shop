...
SECRET_KEY = 'django-insecure-r!w05rec_irfv8e(u$@(hh&rcdtas3qvp*a4j8m_+on5-#d79i'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.IsAuthenticatedOrReadOnly',  # Глобально задаю: чтение для всех, запись для авторизованных
    ],
...
#         "LOCATION": "redis://127.0.0.1:6379/1",  # 1 — номер БД Redis    #"unique-snowflake"     
#         "OPTIONS": {
...
# CACHE_MIDDLEWARE_SECONDS = 60*15  # Кэширование на 15 минут
